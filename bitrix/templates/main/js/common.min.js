$(document).ready(function() {
   ...
   */
    ...
    var LSlider = $('#imageGallery').lightSlider({
        ...
        galleryMargin:20,
        controls: true,
        prevHtml: '<i class="fa fa-chevron-circle-left fa-2x" aria-hidden="true"></i>',
        nextHtml: '<i class="fa fa-chevron-circle-right fa-2x" aria-hidden="true"></i>',
        ...
        onSliderLoad: function(el) {
            ...
            el.on('onSlideClick.lg', function () {
                el.data('lightGallery').goToNextSlide();
            });
        }
    });
    ...
    $('#select_prh').selectmenu({
        select: function( event, ui ) {
			...
			url.searchParams.set('ELEMENT_SORT_FIELD', ui.item.value);
    ...
    */
    ...
    if($('.compare-items').length){
        if (window.matchMedia("(min-width: 1019px)").matches){
            ...
            (function(){
                var inn = document.querySelector('.compare-page .inn');
                if (!inn) return;
                var startX = 0, startY = 0;
                inn.addEventListener('touchstart', function(e){ startX = e.touches[0].clientX; startY = e.touches[0].clientY; }, {passive: true});
