...
<!-- Код с графиком на праздники -->


<?php if (!empty($arItem['HOLIDAY_SCHEDULE']['VALUE'])): ?>
    <div class="holiday-schedule">
        <div class="tit">
            <span>График на праздники:</span>
        </div>
        <div class="time">
            <?php if (is_array($arItem['HOLIDAY_SCHEDULE']['VALUE'])): ?>
                <?php foreach($arItem['HOLIDAY_SCHEDULE']['VALUE'] as $v): ?>
                    <div style="color: #ff000a;"><?=$v?></div>
                <?php endforeach; ?>
            <?php else: ?>
                <div style="color: #ff000a;"><?=$arItem['HOLIDAY_SCHEDULE']['VALUE']?></div>
            <?php endif; ?>
        </div>
    </div>
<?php endif; ?>
...
<!-- Конец кода на праздники -->
					...
					<div class="co__heads cl">
						...
						<div class="rh-col">
							<div class="lvl">Коммерческий директор</div>
						...
						<div class="rh-col">
							...
							<div class="mail">e-mail: <a href="mailto: popova@polimer-vrn.ru">polimer-al@mail.ru</a></div>
						</div>
